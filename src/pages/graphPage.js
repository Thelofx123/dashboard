...
const Chart = () =>{
    ...
    return(
        <Container maxWidth="lg" sx={{height:'100vh',display:'flex',justifyContent:'space-between'}}>
            ...
            {isloaded ? <SquareBox data={pro} name={"Орлого"}></SquareBox> : null}
            {isloaded ? <SquareBox data={delivered} name={"Хүргэсэн"}></SquareBox> : null}
            {isloaded ? <SquareBox data={order} name={"Захиалга"}></SquareBox> : null}
